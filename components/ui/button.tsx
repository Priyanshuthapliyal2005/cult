...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-blueberry to-ube text-white hover:shadow-md",
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          "border border-input bg-background hover:border-blueberry hover:bg-accent/10 hover:text-accent-foreground",
        secondary: 
          "bg-white text-primary border border-border hover:border-blueberry hover:shadow-sm",
